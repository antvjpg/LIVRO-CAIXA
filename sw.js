...
const CACHE_NAME = "livro-caixa-shell-v18-19-fixlayout";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest?v=18-19-fixlayout",
  "./icon-192.png?v=18-19-fixlayout",
  "./icon-512.png?v=18-19-fixlayout",
  "./icon-512-maskable.png?v=18-19-fixlayout"
];
