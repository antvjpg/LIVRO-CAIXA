...
const CACHE_NAME = "livro-caixa-shell-v18-19-fasef";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest?v=18-19-fasef",
  "./icon-192.png?v=18-19-fasef",
  "./icon-512.png?v=18-19-fasef",
  "./icon-512-maskable.png?v=18-19-fasef"
];
